 ...
 */
#define IN865_LC1                                   { CONFIG_LC1_FREQ, 0, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }

/*!
 * LoRaMac default channel 2
 * Channel = { Frequency [Hz], RX1 Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
 */
#ifdef CONFIG_LC2_FREQ
#define IN865_LC2                                   { CONFIG_LC2_FREQ, 0, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#endif
 ...
 * Channel = { Frequency [Hz], RX1 Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
 */
#ifdef CONFIG_LC3_FREQ
#define IN865_LC3                                   { CONFIG_LC3_FREQ, 0, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#endif

/*!
 * LoRaMac channels which are allowed for the join procedure
 */
#if (CONFIG_NUMB_DEFAULT_CHANNELS > 2)
#define IN865_JOIN_CHANNELS                         ( uint16_t )( LC( 1 ) | LC( 2 ) | LC( 3 ) )
#elif (CONFIG_NUMB_DEFAULT_CHANNELS > 1)
#define IN865_JOIN_CHANNELS                         ( uint16_t )( LC( 1 ) | LC( 2 ) )
#elif (CONFIG_NUMB_DEFAULT_CHANNELS > 0)
#define IN865_JOIN_CHANNELS                         ( uint16_t )( LC( 1 ) )
#endif
/*!
